  ...
  return (
    <div className="min-h-screen bg-base-200 pt-20">
      <div className="container mx-auto px-4 max-w-5xl pb-10">
        <div className="bg-base-100 border border-base-300 rounded-2xl p-5 sm:p-7 space-y-6 shadow-sm">
          {/* Header */}
          ...
          <div className="space-y-3">
            ...
            <p className="text-xs text-base-content/70">
              This is a live preview of how your chat will look with the selected theme.
            </p>
          </div>
